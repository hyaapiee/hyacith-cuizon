...
public class AdminMain extends javax.swing.JFrame {
    ...
    public AdminMain() {
       ...
       private void showTable(){
        ...
        try(Connection con = Data.dbConnect()){
            ...
            while (rs.next()){
               ...
               Table.addRow(new Object[] {Name, Amount, Date});
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 0, 760, 80));
        ...
        TabbedPane1.addTab("tab2", jScrollPane1);
        TabbedPane1.addTab("tab1", jLabel3);

        getContentPane().add(TabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 40, 950, 640));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         try{
            ...
            System.getLogger(AdminMain.class.getName()).log(System.Logger.Level.ERROR,(String)null,ex);
